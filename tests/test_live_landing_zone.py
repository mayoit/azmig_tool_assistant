"""
Test script for Live Landing Zone Validator
...
def test_live_landing_zone_validator_import():
    ...
    try:
        from azmig_tool.live import LiveLandingZoneValidator
        from azmig_tool.models import MigrateProjectConfig, ApplianceType

        console.print("  ✓ LiveLandingZoneValidator imported successfully")
...
def test_validator_with_sample_config():
    """Test validator with a sample configuration (mock mode)"""
    console.print(
...
def main():
    ...
    # Test 1: Import
    results.append(("Import Test", test_live_landing_zone_validator_import()))
